...
My place is in Brühl. If you want to understand why [park.fan](/) exists, why
somebody would pour years of his life, countless nights and half a million lines
of code into a fan site about theme parks, you have to start there. Long before
anyone was thinking about wait-time data.
...
People do ask me now and then why park.fan is free and will stay that way. These
parks have given me more than I ever paid them at the gate, and park.fan is my
way of giving some of it back.
...
throughput and latency, in the park it was about queueing, and it took me a very
long time to notice that these are the same question.
...
just stood there: a person who processed data streams in real time for a living
...
## “That park thing again”

What it grew into is what developers call a passion project and girlfriends
probably call “that park thing again”. The script became a data collector, and
at some point it was running for two hundred parks instead of one. In between
were nights spent staring at wait-time curves at two in the morning because some
park reported its data differently from everybody else. Debugging sessions that
...
original **Taron running wheel**. One off the ride, mind you, not a toddler’s
balance bike; that clarification comes up remarkably often when visitors stand
in front of it. This wheel chased thousands of laps through Klugheim before it
was allowed to retire at my place. During every late-night debugging session it
...
- **20 minutes** for
  ...
  after opening? Either a dream day, or the crowds have finally wandered off.
...
There’s no corporation behind this, so nobody tells me what to write. If a park
is badly run, it says so here. If an app is worse than the official one, that
goes here too. Got a topic that’s bugging you? Write to me, the address is in
...
This is my thank-you to a park by a fairy-tale lake, and to two parents who
took a small boy there again and again.
...
coincidence. And to everyone who actually meant to visit him and ended up here
instead: sorry. Head over to [parkfan95.de](https://parkfan95.de), it’s worth
the trip._
