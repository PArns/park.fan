...
export const ATTRACTION_IMAGES: Record<string, string> = {
  ...
  'europa-park/atlantis-adventure': '/images/parks/europa-park/atlantis-adventure.jpg',
  ...
  'phantasialand/geister-rikscha': '/images/parks/phantasialand/geister-rikscha.jpg',
