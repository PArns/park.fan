...
const translations: GlossaryTermTranslation[] = [
  ...
  },
  {
    ...
    name: 'Off-Season',
    shortDefinition:
      'The annual closure period of a seasonal theme park — typically several weeks to months — when the park is completely shut to the public.',
    definition:
      'The off-season is the annual period during which a seasonal theme park is completely closed to visitors. It is not simply a quieter period with fewer guests — the park is shut. For most seasonal parks in Europe, the off-season falls in winter: Phantasialand and Europa-Park, for example, typically close from late January until late March. The exact dates vary by park and year.\n\nDuring the off-season, parks carry out major refurbishments, install new attractions, and perform maintenance work that would be impractical while guests are present. This is why many new rides open right at the start of the new season rather than mid-year.\n\npark.fan displays the off-season indicator on a park card when the park is closed and the next scheduled opening date is more than a week away — distinguishing it from a regular daily closure. If you see the off-season label, the park will not open any time soon: always check the official park website for the exact reopening date before making travel plans.',
