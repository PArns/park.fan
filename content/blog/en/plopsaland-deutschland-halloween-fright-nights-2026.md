...
and unlike Traumatica at Europa-Park it does not turn away under-16s at the
gate.
...
show **"The Killing Games"**, where only one fighter leaves the ring alive. The
...
| Horror house ticket    | from €3 per house            | one house with a time slot, only with a park ticket       |
| All six houses         | €49                          | bundle, park entry not included                           |
| Nightmare Society Pass | from €109 (annual pass: €79) | entry, every house once without a time slot, parking, pin |

Each horror house runs on fixed time slots that you pick when you buy. Only the
Nightmare Society Pass skips them, and it adds a reserved area at the shows.
