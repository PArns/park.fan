 ...
 * cutoff stays 1080 (not 828) because high-DPR phones still request the w=1080 candidate on the
 * wider-`sizes` consumers (park/ride at 100vw), which is the mobile LCP element there. Only the
