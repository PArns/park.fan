...
export function CalendarLegend() {
  ...
  const specialDays = [
    { label: t('schoolVacation') || 'Schulferien', borderColor: '#eab308', emoji: '🎒' },
    { label: t('bridgeDay') || 'Brückentag', borderColor: '#3b82f6', emoji: '🌉' },
    { label: t('holiday') || 'Feiertag', borderColor: '#f97316', emoji: '🎉' },
  ];
