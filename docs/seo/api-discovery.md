...
api.park.fan serves the same catalog at its own root. A well-known URI is asked of whichever
host the client already holds, and something handed an api.park.fan endpoint has no reason to
go looking at the content site first.
