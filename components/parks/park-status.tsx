...
export function ParkStatus({ park, variant, className }: ParkStatusProps) {
        ...
        {waitStats && (
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>
                {waitStats.operatingAttractions}/{waitStats.totalAttractions}
              </span>
            </div>
          </div>
        )}
  ...
  if (variant === 'detailed') {
    ...
    // reads "keine Prognose" and is the whole truthful content of this block for such a park.
    const occupancy = waitStats ? analytics?.occupancy : undefined;
