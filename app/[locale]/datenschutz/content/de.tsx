  ...
  return (
    <>
      ...
      <div className="space-y-6 text-base leading-7">
        ...
        <h3 className="mt-8 mb-4 text-2xl font-semibold">Datenerfassung auf dieser Website</h3>
        ...
        <p className="mb-4">
          ...
          Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung
        ...
        <p className="mb-4">
          Cloudflare bietet ein weltweit verteiltes Content Delivery Network mit DNS an. Dabei wird
        ...
        <p className="mb-4">
          ...
          fehlerfreien und sicheren Bereitstellung unseres Webangebotes (Art. 6 Abs. 1 lit. f
          DSGVO).
        </p>
        <p className="mb-4">
          Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission
          gestützt. Details und weitere Informationen zum Thema Sicherheit und Datenschutz bei
        ...
        <h3 className="mt-8 mb-4 text-2xl font-semibold">Hinweis zur verantwortlichen Stelle</h3>
        <p className="mb-4">
        ...
        <h3 className="mt-8 mb-4 text-2xl font-semibold">Empfänger von personenbezogenen Daten</h3>
        <p className="mb-4">
          ...
          externen Stellen erforderlich. Wir geben personenbezogene Daten nur dann an externe
          Stellen weiter, wenn dies im Rahmen einer Vertragserfüllung erforderlich ist, wenn wir
          gesetzlich hierzu verpflichtet sind (z. B. Weitergabe von Daten an Steuerbehörden), wenn
          wir ein berechtigtes Interesse nach Art. 6 Abs. 1 lit. f DSGVO an der Weitergabe haben
        ...
        <p className="mb-4">
          <strong>
            ...
            WIDERSPRECHEN, WERDEN WIR IHRE PERSONENBEZOGENEN DATEN ANSCHLIESSEND NICHT MEHR ZUM
        ...
        <h3 className="mt-8 mb-4 text-2xl font-semibold">Auskunft, Berichtigung und Löschung</h3>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          Wenn Sie der Standortfreigabe in Ihrem Browser ausdrücklich zustimmen, verwenden wir die
          präzisen GPS-Koordinaten Ihres Geräts. Erteilen Sie keine Freigabe, wird Ihr ungefährer
          Standort anhand Ihrer IP-Adresse (GeoIP) bestimmt. Die Koordinaten bzw. die IP-basierte
          Näherung werden ausschließlich an unsere eigene Schnittstelle (api.park.fan) übermittelt,
          um die nächstgelegenen Parks zu berechnen. Eine dauerhafte Speicherung dieser
          Standortdaten auf unseren Servern oder eine Weitergabe an Dritte erfolgt nicht.
        </p>
        <p className="mb-4">
          Rechtsgrundlage für die Verarbeitung präziser Standortdaten ist Ihre Einwilligung (Art. 6
          Abs. 1 lit. a DSGVO), die Sie jederzeit über die Standorteinstellungen Ihres Browsers
          widerrufen können. Die IP-basierte Näherung sowie die Bereitstellung der Funktion beruhen
          auf unserem berechtigten Interesse an einem nützlichen Angebot (Art. 6 Abs. 1 lit. f
          DSGVO).
        </p>
        ...
        <p className="mb-4">
          ...
          lokalen Speicher (Local Storage) Ihres Browsers – beispielsweise um Ihre Einstellungen und
          Ihre Standortfreigabe zu merken oder abgerufene Ergebnisse zwischenzuspeichern, damit
          wiederholte Anfragen vermieden werden. Dabei handelt es sich ausschließlich um
          First-Party-Daten ohne Tracking, die auf Ihrem Endgerät verbleiben und nicht an uns oder
          Dritte übertragen werden. Sie können diese Daten jederzeit über die Einstellungen Ihres
          Browsers löschen. Da der Zugriff auf diesen Speicher unbedingt erforderlich ist, um die
          von Ihnen gewünschten Funktionen bereitzustellen, ist hierfür keine Einwilligung
          erforderlich (§ 25 Abs. 2 Nr. 2 TDDDG); die Verarbeitung erfolgt auf Grundlage von Art. 6
          Abs. 1 lit. f DSGVO.
        </p>
        ...
        <p className="mb-4">
          ...
          Foundation, St John's Innovation Centre, Cowley Road, Cambridge, CB4 0WS, Großbritannien,
          ein. Großbritannien gilt als datenschutzrechtlich sicherer Drittstaat. Das bedeutet, dass
          Großbritannien ein Datenschutzniveau aufweist, das dem Datenschutzniveau in der
          Europäischen Union entspricht. Bei der Nutzung der OpenStreetMap-Karten wird eine
          Verbindung zu den Servern der OpenStreetMap-Foundation hergestellt. Dabei können u. a.
          Ihre IP-Adresse und weitere Informationen über Ihr Verhalten auf dieser Website an die
          OSMF weitergeleitet werden. OpenStreetMap speichert hierzu unter Umständen Cookies in
          Ihrem Browser oder setzt vergleichbare Wiedererkennungstechnologien ein.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          Wir nutzen den Webanalysedienst Umami, um die Nutzung unserer Website zu analysieren und
          regelmäßig zu verbessern. Über die gewonnenen Statistiken können wir unser Angebot
          verbessern und für Sie als Nutzer interessanter ausgestalten.
        </p>
        <p className="mb-4">
          Umami ist ein datenschutzfreundlicher Webanalysedienst, der ohne Cookies arbeitet und alle
          erfassten Daten vollständig anonymisiert. Es werden keine personenbezogenen Daten
          gespeichert oder verarbeitet, die eine Identifikation einzelner Nutzer ermöglichen würden.
          Die erfassten Daten umfassen lediglich technische Informationen wie Browsertyp,
          Betriebssystem, besuchte Seiten und Verweisquelle, jedoch werden IP-Adressen nicht
          gespeichert.
        </p>
        <p className="mb-4">
          Der Dienst wird in einem Rechenzentrum innerhalb der Europäischen Union gehostet, sodass
          Ihre Daten die EU nicht verlassen. Eine Weitergabe an Dritte erfolgt nicht.
        </p>
        <p className="mb-4">
          Die Rechtsgrundlage für die Nutzung von Umami ist Art. 6 Abs. 1 lit. f DSGVO. Unser
          berechtigtes Interesse liegt in der Optimierung und dem wirtschaftlichen Betrieb unserer
          Website. Da Umami ohne Cookies arbeitet und keine personenbezogenen Daten erhebt, ist
