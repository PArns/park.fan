    ...
    <Card className="p-6" hover="lift">
      ...
      <div className="space-y-4">
        {validContinents.map((continent) => (
          <div key={continent.continent} className="p-4 bg-muted/30 rounded-lg">
            <div className="flex items-center gap-3 mb-3">
              <span className="text-2xl">{getContinentEmoji(continent.continent)}</span>
              <div className="flex-1">
                <h4 className="font-medium text-foreground">{continent.continent}</h4>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-foreground">
                  {continent.openRides.toLocaleString()} / {continent.totalRides.toLocaleString()}
                </span>
              </div>

              <div className="flex items-center gap-2">
                <Progress value={(continent.totalRides / maxRides) * 100} className="flex-1 h-2" />
                <div
